...
\begin{multicols*}{2}
    ...
    \begin{enumerate}
        ...
        \item $\frac{-(\ln(9))^5}{5!}$
    \end{enumerate}
    The emergent pattern seems to be \boxed{\frac{f^{(n)}(0)}{n!}=(-1)^n\frac{(\ln(9))^n}{n!}}
    \subsection*{\textbf{The Maclaurin Series}}
    Using the known coefficient pattern, we can multiply the general term by $x^n$ and make it a summation \boxed{\sum_{n=0}^{\infty}\frac{f^{(n)}(0)}{n!}x^n=\sum_{n=0}^{\infty}(-1)^n\frac{(\ln(9))^n}{n!}x^n}
